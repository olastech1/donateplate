...
export default function TermsPage() {
  ...
  const defaultContent = `
    <div style="color: var(--text-secondary); line-height: 1.8;">
      ...
      <p style="margin-bottom: 16px;">By accessing or using Donate Plea, you agree to be bound by these Terms. If you disagree with any part of the terms, you may not access the platform.</p>
      <h3 style="margin-top: 24px; margin-bottom: 12px; color: var(--slate-800);">2. Use of the Platform</h3>
      <p style="margin-bottom: 16px;">Donate Plea is a platform to facilitate donations to verified campaigns. We are not a broker, financial institution, or charity. We do not guarantee the accuracy of campaign claims, though we enforce strict KYC policies for creators.</p>
